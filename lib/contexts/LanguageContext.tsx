...
const translations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    naoHaMagiaTeaserPendente: 'Inserir teaser de Não Há Magia aqui',
    pactoDaViolaImagemPendente: 'Inserir imagem de O Pacto da Viola aqui',
    arquivoMaterialPendente: 'Inserir material de mostras, exposições e projetos especiais aqui',
    arquivoImagemPendente: 'Inserir imagem de mostras e exposições aqui',
    ...
    festival: 'Festival',
    premioTag: 'Prêmio',
    berlinaleDescricao: 'Generation KPlus, Filme de Abertura. Uma estreia histórica que marca o primeiro longa-metragem internacional da Moveo Filmes em um dos festivais mais prestigiosos do mundo.',
    rotuloDistribuicao: 'Distribuição',
    rotuloFichaTecnica: 'Ficha Técnica',
    rotuloBrasil: 'Brasil:',
    rotuloInternacional: 'Internacional:',
    rotuloLancamentoBrasil: 'Lançamento Brasil:',
    arquivoDeImprensa: 'ARQUIVO DE IMPRENSA',
    entreEmContato: 'ENTRE EM CONTATO',
    contatoTitulo: 'Contato',
    contatoChamada: 'Fale com a Moveo para projetos, parcerias e informações gerais.',
    rotuloFundacao: 'Fundação',
  },
  en: {
    catalog: 'Catalog',
    media: 'News',
    ...
    naoHaMagiaTeaserPendente: 'Insert Não Há Magia teaser here',
    pactoDaViolaImagemPendente: 'Insert O Pacto da Viola image here',
    arquivoMaterialPendente: 'Insert showcases, exhibitions and special projects material here',
    arquivoImagemPendente: 'Insert showcase and exhibition image here',
    lancamento: 'Release:',
    ...
    festival: 'Festival',
    premioTag: 'Award',
    berlinaleDescricao: 'Generation KPlus, Opening Film. A historic premiere marking Moveo Filmes\' first international feature at one of the world\'s most prestigious festivals.',
    rotuloDistribuicao: 'Distribution',
    rotuloFichaTecnica: 'Credits',
    rotuloBrasil: 'Brazil:',
    rotuloInternacional: 'International:',
    rotuloLancamentoBrasil: 'Brazil release:',
    arquivoDeImprensa: 'PRESS ARCHIVE',
    entreEmContato: 'GET IN TOUCH',
    contatoTitulo: 'Contact',
    contatoChamada: 'Talk to Moveo about projects, partnerships and general information.',
    rotuloFundacao: 'Founded',
    // Placeholder texts
