...
interface ContentTransition2Props {
  leftText?: { line1: string; line2: string }
  rightText?: { line1: string; line2: string }
  boxCount?: number
}

export default function ContentTransition2({
  leftText = { line1: "AS", line2: "MIÇANGAS" },
  rightText = { line1: "O MISTÉRIO", line2: "DA CARNE" },
  boxCount = 100,
}: ContentTransition2Props) {
