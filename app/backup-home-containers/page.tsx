...
export default function BackupHomeContainers() {
  ...
  useEffect(() => {
    if (pathname === '/backup-home-containers') {
      const timer = setTimeout(() => {
        if (containerRef.current && containerRef.current.offsetWidth > 0) {
          const targetWidth = containerRef.current.offsetWidth;
          const measureElement = document.createElement('div');
    ...
    <MainLayout>
      ...
      >
        ...
        >
                ...
                <div className="grid md:grid-cols-2 gap-6 h-full">
                  <div className="flex flex-col gap-6 h-full min-h-0">
                    <div className="grid grid-cols-4 grid-rows-3 flex-1 min-h-0 gap-2">
                      {/* Linha A */}
                      <div className="bg-[#9b7a7a] rounded-lg"></div>
                      <div className="bg-[#f08080] rounded-lg col-span-2"></div> {/* A2+A3 mescladas */}
                      <div className="bg-[#9b7a7a] rounded-lg"></div>

                      {/* Linhas B e C - Retângulo B1+B2+C1+C2 */}
                      <div className="bg-[#6b3838] rounded-lg col-span-2 row-span-2"></div> {/* B1+B2+C1+C2 mescladas */}
                      <div className="bg-[#f08080] rounded-lg"></div>
                      <div className="bg-[#9b7a7a] rounded-lg"></div>
                    ...
                    <div className="grid grid-rows-2 flex-1 min-h-0 gap-2">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div className="bg-[#7a9b9b] rounded-lg p-4 flex items-end justify-start">
                          <p className="text-white text-sm md:text-base lg:text-lg font-medium">Brasília, desde 2018</p>
                        </div>
                        <div className="bg-[#5a7b7b] rounded-lg"></div>
                      </div>

                      {/* Container maior inferior com texto */}
                      <div className="bg-[#4a5d5d] rounded-lg p-4 md:p-6 flex items-end justify-start">
                        <p className="text-white text-sm md:text-base lg:text-lg font-medium">
                          Produtora boutique de
                          <br />
                  ...
                  <div className="flex flex-col gap-6 h-full min-h-0">
                    <div className="bg-black rounded-lg p-4 md:p-6 lg:p-8 flex items-center justify-center flex-[1] min-h-0">
                    ...
                    <div className="grid grid-cols-3 flex-[2] min-h-0 gap-2">
                      ...
                      <div className="col-span-2 bg-[#8b6b6b] rounded-lg p-4 md:p-6 flex items-end justify-start">
                        <p className="text-white text-sm md:text-base lg:text-lg font-medium">
                          Focado em promissores
                          <br />
                      ...
                      <div className="grid grid-rows-3 gap-2">
                        <div className="row-span-2 bg-[#d4a574] rounded-lg"></div>
                        <div className="bg-[#6b4e3d] rounded-lg"></div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="w-full h-full p-[50px] box-border">
              <div className="max-w-7xl mx-auto w-full h-full grid md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col h-full min-h-0">
                  {/* Container Superior */}
                  <div className="flex-1 bg-amber-100 flex items-end p-4 md:p-6 lg:p-8 min-h-0">
                    <p className="text-lg md:text-xl lg:text-2xl font-bold text-zinc-900 leading-tight">
                      Um histórico sólido de colaborações com talentos emergentes
                    </p>
                  </div>

                  {/* Container Central */}
                  <div className="flex-1 bg-rose-200 flex items-end p-4 md:p-6 lg:p-8 min-h-0">
                    <p className="text-lg md:text-xl lg:text-2xl font-bold text-zinc-900 leading-tight">
                  ...
                  <div className="flex-1 grid grid-cols-4 grid-rows-4 min-h-0 gap-2">
                    ...
                    {/* A3 */}
                    <div className="row-span-2 bg-rose-300 col-start-3"></div>

                    {/* A4 */}
                    <div className="row-span-2 bg-orange-400 col-start-4"></div>

                    {/* Container mesclado: A'1, A'2, B1, B2, B'1 e B'2 */}
                    <div className="col-span-2 row-span-3 bg-red-200 col-start-1 row-start-2"></div>

                    {/* B4 */}
                    <div className="row-span-2 bg-amber-400 col-start-4 row-start-3"></div>
                  </div>
                </div>

                <div className="grid grid-cols-5 grid-rows-5 h-full min-h-0 gap-2">
                  {/* Container grande mesclado: A1-A4, B1-B4, C1-C4 (12 células) */}
                  <div className="col-span-4 row-span-3 bg-black flex items-center justify-center p-4 md:p-6 lg:p-8 col-start-1 row-start-1">
                    <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-black tracking-tight text-white text-center leading-tight">
                      FILMES DESTAQUE DO NOSSO CATÁLOGO
                    </h2>
                  </div>

                  {/* A5 */}
                  <div className="bg-rose-400 col-start-5 row-start-1"></div>

                  {/* B5 */}
                  <div className="bg-orange-300 col-start-5 row-start-2"></div>

                  {/* C5 e D5 mesclados */}
                  <div className="row-span-2 bg-amber-300 col-start-5 row-start-3"></div>

                  {/* D2 */}
                  <div className="bg-red-300 col-start-2 row-start-4"></div>

                  {/* D5 - já mesclado com C5 acima */}

                  {/* E1 e E2 mesclados */}
                  <div className="col-span-2 bg-rose-500 col-start-1 row-start-5"></div>
                </div>
              </div>
            </div>
          </section>

          {/* Nova Seção 1 - SOBRE A MOVEO (movida) */}
          <section
            className="horizontal-section relative flex-shrink-0 text-white"
            style={{ width: 'calc(100vw - 100px)', height: 'calc(100vh - 100px)' }}
          >
          ...
          {/* Nova Seção 2 - UM HISTÓRICO SÓLIDO (movida) */}
          <section
            className="horizontal-section relative flex-shrink-0 text-white"
            style={{ width: 'calc(100vw - 100px)', height: 'calc(100vh - 100px)' }}
          >
